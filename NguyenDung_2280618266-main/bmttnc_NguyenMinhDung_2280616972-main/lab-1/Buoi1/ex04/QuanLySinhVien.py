...
class QuanLySinhVien:
    ...
    def showSinhVien(self, sv):
        print("Ma SV: {}".format(sv._id))
        print("Ten SV: {}".format(sv._name))
        print("Gioi tinh: {}".format(sv._sex))
        print("Chuyen nganh: {}".format(sv._major))
        print("Diem TB: {}".format(sv._diemTB))
        print("Hoc luc: {}".format(sv._hocLuc))
